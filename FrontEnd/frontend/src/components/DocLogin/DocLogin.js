...
import { authenticateDoctor } from "../../services/authService"; // Import authentication service
import "./DocLogin.css"; // Import styles
...
const DocLogin = () => {
  ...
  const checkLogin = () => {
    if (authenticateDoctor(username, password)) {
      navigate("/docdash"); // Redirect to Doctor Dashboard
